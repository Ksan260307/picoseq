...
STRINGS = {
    ...
    # 有料化 / ライセンス
    "btn_license": {"ja": "🔑 ライセンス", "en": "🔑 License"},
    "lic_title": {"ja": "ライセンス — 有料版の解放", "en": "License — unlock the paid version"},
    "lic_status_pro": {"ja": "✅ 有料版が有効です。すべての機能を使えます。",
                       "en": "✅ Paid version active. All features unlocked."},
    "lic_status_free": {
        "ja": "現在は無料版です。\n・自動生成: 1 日 {limit} 回まで (本日の残り {remaining} 回)\n・書き出し: WAV のみ (MIDI は有料版)",
        "en": "You are on the free version.\n· Auto-generate: up to {limit}/day ({remaining} left today)\n· Export: WAV only (MIDI is paid)"},
    "lic_intro": {"ja": "プロダクトコードを入力すると、自動生成が無制限になり MIDI 書き出しが使えます。",
                  "en": "Enter a product code to unlock unlimited auto-generation and MIDI export."},
    "lic_prompt": {"ja": "プロダクトコード", "en": "Product code"},
    "lic_activate": {"ja": "有効化する", "en": "Activate"},
    "lic_close": {"ja": "閉じる", "en": "Close"},
    "lic_invalid": {"ja": "コードが正しくありません。もう一度確認してください。",
                    "en": "That code isn't valid. Please check and try again."},
    "lic_activated": {"ja": "✅ 有料版を有効にしました。ありがとうございます!",
                      "en": "✅ Paid version activated. Thank you!"},
    "lic_already_pro": {"ja": "すでに有料版が有効です。", "en": "The paid version is already active."},
    "st_quota_reached": {
        "ja": "本日の自動生成 ({limit} 回) を使い切りました。🔑 ライセンスで有料版にすると無制限です。",
        "en": "You've used today's auto-generations ({limit}). Unlock unlimited via 🔑 License."},
    "st_free_remaining": {"ja": " (無料: 本日あと {remaining} 回)", "en": " (free: {remaining} left today)"},
    "st_midi_paid": {
        "ja": "MIDI 書き出しは有料版の機能です。🔑 ライセンスから解放できます (WAV は無料で使えます)。",
        "en": "MIDI export is a paid feature. Unlock it via 🔑 License (WAV is free)."},
}
